...
int main( int argc, char* argv[] )
{
    try
    {
        ...
        size_t reply_length = boost::asio::read( s, boost::asio::buffer( reply_bytes, 4 ),
                                                 boost::asio::transfer_exactly( 4 ) );
        ...
        reply_length = boost::asio::read( s, boost::asio::buffer( reply, reply_size ),
                                          boost::asio::transfer_exactly( reply_size ) );
